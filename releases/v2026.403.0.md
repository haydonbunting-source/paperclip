...
- **Telemetry controls** — Anonymized App-side telemetry controls. Current hardened builds keep telemetry opt-in and honor `DO_NOT_TRACK=1` or `PAPERCLIP_TELEMETRY_DISABLED=1`. ([#2527](https://github.com/paperclipai/paperclip/pull/2527))
